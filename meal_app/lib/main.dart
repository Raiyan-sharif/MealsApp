  ...
  void _setFilters(Map<String,bool> filterData){
    setState(() {
      ...
      _availableMeals = DUMMY_MEALS.where((meals) {
        if(_filters['gluten'] as bool && !meals.isGlutenFree){
          return false;
        }
        else if(_filters['lactose'] as bool && !meals.isLactoseFree){
          return false;
        }
        else if(_filters['vegan'] as bool && !meals.isVegan){
          return false;
        }
        else if(_filters['vegetarian'] as bool && !meals.isVegetarian){
          return false;
        }
